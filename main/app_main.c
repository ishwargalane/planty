...
void app_main()
{
    ...
    esp_rmaker_node_t *node = esp_rmaker_node_init(&rainmaker_cfg, "Planty", "The Plant Monitor");
    if (!node) {
     ...
     */
    switch_device = esp_rmaker_device_create("Water Supply", ESP_RMAKER_DEVICE_SWITCH, NULL);
     ...
     * parameter.
     */
    esp_rmaker_device_add_param(switch_device, esp_rmaker_name_param_create(ESP_RMAKER_DEF_NAME_PARAM, "Water Supply"));
